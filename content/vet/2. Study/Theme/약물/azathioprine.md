...
- 제품명 :: 이무란(Imuran)
- 분류 :: 면역억제제 > 유지 면역억제제 > 항증식제
- 특징 :: T림프구 억제<br>부작용 골수억압, 고양이에서는 금지.
- 임상 :: 면역매개질환 (IMHA, ITP, IMPA 등등)

> ##### 관련 문서

- [[남내1(A) - 03. 원발성 면역매개질병의 약물 치료|남내1(A) - 03. 원발성 면역매개질병의 약물 치료]] (아래 첨부)
- [[안과(A) - 4. 안와, 안구의 질환|안과(A) - 4. 안와, 안구의 질환]] : Episcleritis에 사용
- [[B04. azathioprine (아자티오프린) & mycophenolate|B04. azathioprine (아자티오프린) & mycophenolate]] : 핵산 합성을 억제하여 림프구 증식을 차단함. 
	- [azathoprine] 뉴클레오타이드 유사체로 전환된 후, 핵산 사슬로 편입되어 DNA 연장을 차단함투여용량 제한. 부작용은 골수억제.
