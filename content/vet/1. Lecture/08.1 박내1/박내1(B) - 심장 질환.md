...
- <font color="#0070c0"><b>2 Artrioventricular valves : 방실판</b></font> (심방과 심실 사이)
	- **Mitral valves** (**이첨판**/승모판)
	- **Tricuspid valves** (**삼첨판**)
-  <font color="#00b050"><b>2 semilunar valves : 반월판</b></font>
	- Aortic valve (대동맥판)
	- Pulmonary valve (폐동맥판)

![[Pasted image 20241217182803.png|600]]

#### 방사선 사진

![[Pasted image 20241030114050.png|450]]
...
|     |                                                                                                           |
| --- | --------------------------------------------------------------------------------------------------------- |
| 정의  | 이첨판(Mitral valve, LA와 LV 사이) 이상 ⇒ 좌심방 비대.                                                                 |
...
| MVI + CTR<br>(CTR = chordae tendineae rupture), bivalvular                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![[Pasted image 20241217203249.png\|220]] ![[Pasted image 20241217203258.png\|116]]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
|                     | ☑️ **Differential cyanosis** (분리 청색증) 나타남.<br>: 산소 포화도가 낮은 <u>폐동맥 혈액이 전신 순환에 합류</u> → systemic한 저산소증 발생<br>→ 산소 포화도 감소 → 산소가 필요해 <u>빈호흡, 빈맥</u><br>→ 호흡 곤란, 운동 불내증, 객혈, Epo 증가로 적혈구증가증 (<u>PCV 증가</u>)<br>→ <u>Thromboembolism</u>(혈전 잘 생김), 혈액 끈적<br>→ <u>혈압 증가</u> → 작은 혈관 터짐 (뇌출혈)<br><br>❔분리 청색증❔<br>- 동맥관 앞의 피는 산소 포화도 높음 - 이 혈액들은 머리 쪽으로 감, 머리에는 청색증 X.<br>- 동맥관 뒤의 피는 산소 포화도 낮아짐 - 이 혈액들은 전신 순환, 몸에서는 청색증. |
|                     | 치료 어려움. (Duct 묶으면 심장의 right side에 심한 압력이 걸림, 폐가 커지고 폐출혈)<br>→ 예후도 좋지 않음.<br><br>💊 약물 처방<br>- 폐동맥 확장제 : **Sildenafil**, **Nitroglycerin**, **Hydralazine** 등 (but 불충분)<br>- Endothelin 차단제 : 혈관을 수축시키는 호르몬을 차단 → 혈관 확장<br>- [[Prostacyclin|Prostacyclin]] : 혈관 확장제이자 항혈소판제.                                                                                                                                                    |
...
### MVI (Mitral valve insufficiency), TVI (Tricuspid valve insufficiency)

- 나이가 들면서 퇴행성으로 glycosaminoglycan이 차서 이첨판이 두꺼워짐 → valve가 잘 닫히지 않음.
- 가장 흔한 퇴행성 질병.
- King Charles Spaniel : 어린 연령에도 MVI가 잘 생김.

### 구조적 질병

- 심장에 murmur가 들릴 때는 심장에 구조적 문제가 있다는 의미.
-- valve disease degeneration

> 청진 꼼꼼히, 차트 잘 작성! Back to basic ~~~

- 심장 질병 → 몸에 blood volume 많아짐 → Left atrium dilation
- 100% 중 70%만 내보내지고 있다면? 
	- Cardiac output을 높여야 함.
	- Heart rate 올리면 blood pressure 높아짐.
	- 뇌하수체에서 ADH 분비 → 콩팥에서 물으
	- aldosterone → 나트륨을 오줌에서 몸 안으로 빨아들임. 나트륨과 물이 같이 들어옴 → 고혈압도 같이

if) LA에서 LV로 30L의 혈액이 저류

- LA dilation - LV dilation까지 이어진다
- pulmonary edema
- 작은 모세혈관이 
- tachpnea

### 1기단계: MVI (Mild cardiac remodeling)
...
- 혈압이 높다. pulmonary vein hypertension
...
>[!check] 오늘 배운 것
> - Volume overload
> - Left artrium dilation
> - pulmonary vein dilation
> - systolic --tension murmur
> - pulmonary 

- 이뇨제 (벤니톨, 

- Angiotensing Ⅱ가 이런 문제를 만듦.
- vasocontriction - ? 쓰면 혈관 확장 일어남
	- aldosteron 차단, ADH 차단, 물의 재흡수를 저하, 
	- enro..pril A
...
| ----------------------------------------- | ----------------------------------------- | ------------------------------------ |
| **1기 단계**                                 |                                           |                                      |
| ![[Pasted image 20241106115908.png\|250]] | ![[Pasted image 20241106115929.png\|127]] |                                      |
| **2기 단계**                                 |                                           |                                      |
| ![[Pasted image 20241106120002.png\|250]] | ![[Pasted image 20241106120208.png\|127]] | - pulmonary vein congestion (폐가 뿌옇게) |
|                                           |                                           |                                      |

### MVI 1기단계: Mild cardiac remodeling

- sternal contact :
- cranial/caudal waist :
- tracheal elevation :
- bronchial collapse :
- 교수님은 조기 치료가 중요하다고 생각하는 편

#### 치료

- ACE inhibitor (ACEI) : 심장병에서 초기부터 반드시! 써야 한다
	- 심장 질병은 결국 내분비 질병을 유발함
	- RAS activation을 막아줌
	- 15mmHg
	- 혈압을 떨어뜨리는 약 중 mild함
- Diuretics(이뇨제) : 
- Furosemide (1mg/kg) PO BID - 3mg는 진짜 위중한 개, 써본 거 X
	- 장기간 사용 시 hypercalemia?
- Spironolactone (1mg/kg BID PO) : 
	- 적절한 용량 조절이 중요
	- 물이 더 빠져나가면서 알칼리성 ,., 탈수, 혈압 떨어짐. RAS system 다시 activcatin, 
	- 혈압과 비례하게 올라가는 renin 검사해서 약물 용량 조절.
- ?를 투여해서 ?를 예방하는 게 좋음..
- 아주 초기에는 ACEI 0. 이뇨제 쓰고, furosemide 쓰고, 반응 별로면 spironolactone 추가.
- cardiac remodeling 초기에 막아야 한다.
	- murmur가 있지만 cough는 없을 수 있다.

- 혈액 검사, 나트륨 검사 → ACEI

### MVI 2기단계: Moderate cardiac remodeling

- 운동불내증, 기침 증상
- 초음파상 혈액 역류 심하고, 파남ㄱ 두꺼워짐, 심방 확장 
- mixomatous degeneration

- 보상성 (compensation) - 필요한 부분만 채워주면 됨
- 보상할 수 없음 (decompensate) → 심장에 물 참
	- heart failure (심장 기능이 거의 end stage
	- decompensation의 critical sign : syncope → 강심제 사용

### MVI 3기단계: Severe cardiac remodeling

- VHS 14.5
- 심장 엄청 커짐
- ![[Pasted image 20241113111251.png|300]]![[Pasted image 20241113111259.png|200]]

- 심방에서 anp, 심실에서 vnp가 나옴.
- NT proVNP (N terminal pro-VNP)
	- 의 troponin I, troponin C, troponin T 중 I만 검출가능하고 진단적 의의 있음
- bivalvular insufficiency라고 함. 
![[Pasted image 20241113112021.png|300]]
- airophagia (공기를 먹었다는 뜻) - 위가 공기로 차서 빵빵해짐
- 부채꼴 같은 모양 → scallop sign : 가리비 모양. 물이 아래로 가라앉아 나타남.
- 울혈성 심부전
![[Pasted image 20241113112145.png|200]]
- cardiac silluet sign : 흉수(pleural effusion; 폐 바깥에 참), lung collapse가 발생. 호흡곤란, 빈호흡 발생.

caudal tendinae rupture ; 채찍 모양, heart failure 단계로 진행된다

강심제를 처방한다.

- 1회 심박출량이 감소되었을 때 사용 (decreased SV)
- Digoxin : 0.005-0.01mg/kg PO BID
	- 혈관 확장 기능이 없으나, 교감신경을 차단하는 기능을 가지고 있다.


- FS(fractional shortening, 심장수축력)
- 처음에는 아주 조금만 새니까, 조금만 보상해주면 됨. : HR 조금 상승, FS 정상 → 강심제 쓸 필요 없다. HR 정상화 필요. - Calcium channel blocker.
- 조금 더 진행되면 : FS 감소, HR 더 상승 → 강심제를 써야 함.
- 계속 빨리 뛰면 tachycardia-induced myopathy? 심장근육 마비됨.
- 만약 FS가 증가했으면? 보상 작용 되고 있는 것

#### Pimobendan

- 혈관 확장 기능 있음
- 수축력 증가시킴 (sensitizes proteins to calcium) 
- Cardiac output 증가됨
- 강심제이면서 약한 vasodilation 효과를 가짐
- tachycardia로 심장이 이미 보상작용 하는 중에, 강심제까지 처방하면, 심장이 더 무리해서 심무력증이 더 빨리 온다
- hydralazine (동맥확장제)
- ACEI+Pimobendan?
 Digoxin+Pimobendan?
 Hydralazine+Pimobendan?
 ACEI+Hydralazine+Digoxin+pimobendan? 가능, but
 Niteroglycerin : 더 강력한 동맥확장제

![[Pasted image 20241113121030.png|Pasted image 20241113121030.png]]

left side에 congestion 오면

pulmonary edema (alveolar에 물이 참)

우심방에 congestion 계속 생김

caudal vena cava

-> cranial vena cava도 커지겠지??

뇌의 산소 포화도가 당연히 낮아짐

spleen에 정맥피가 고여서 congestion 생김

splenomegaly

더 심해지면 물이 혈관 밖으로 흘러나옴 (복수, 흉수)

Right side heart failure

splenomegaly, hepatomegaly, 복수흉수

intestine의 정맥피가 caudal vena cava로 잘 못 감, 장에 피가 고임, 흡수가 잘 안 되고 체중이 감소

Left side heart failure

coughing, syncope, pulmonary edema

aneurism : 혈관이 부풀어오를 수 있다

혈관확장제

Sildenafil, Tadanafil

hydralazine, ACEI도 물론 쓸 수 있으나, 약하다

NG : 동맥과 정맥을 확장시키는

NG+sildenafil : 저혈압이 생길 수 있음, BP 모니터링 필요

---


- 고양이는 솜털이 흩어진 모양의 pulmonary edema 패턴이 나타난다.
- 호흡 곤란, 폐수종, 운동불내성, 기침 동반함

### Complicated Pulmonary edema

>[!tldr] Case) Chihuahua, 13y
>- hemoptosis, dyspnea, tachycardia, syncope
>- hypertensive (수축기 혈압 140~160)
>- murmur grade 5/6 (매우 심각)

### 응급 치료 (FON)

- 강심제(Dopamine)
- FON-P (Pimobendan)
- cardiac failure를 잘 넘겨야 한다.
- Furosemide (정맥주사용) - 혈압이 확 떨어짐. 다른 약에서 반응이 없을 때 선택
- 정맥으로 계속 약물 들어감 - 정맥 확장
- Nitroprusside - 응급 상황에서만. 너무 많이 쓰면 ㅍ켸의 물은 빼지만 전신동맥으로 퍼지면서 
