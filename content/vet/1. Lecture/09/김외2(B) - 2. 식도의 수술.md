...
- 위치상 심장/폐에 영향을 미치리 수 있으므로, 식도 수술과 관련된 합병증이 치명적.
...
- Pulmonary shunt의 예방
	...
	- 누워 있으면 위의 폐가 아래를 누르게 됨
- 환기를 시켜서 무기폐 상태를 없애고 폐수종을 개선 : 압으로서 폐포를 확장시켜 줘야 함.
- Tidal volume (1회 환기량) : 보통 10ml/kg인데, 강제 환기 시 15ml/kg 정도 됨
- Aspiration pneumonia : 양압 환기(positive pressure ventilation) 과 함께 tidal volume을 많이 가져가면 과함 
- Thoracotomy : Vt 6-10ml/kg: 
- Ispiration time :1-1.5sec
- Prolonged I/T : alveolar capillaries & impede venous return
- Rapid induction (propofol), intubation
- Nitrous oxide : (지금까지도 대체되지 않을 만큼 적합한 기체 마취제. 50% 또는 60% 
	- diffusion hypoxia : 각성시에 확산성 저산소증 
...
- 기관을 오른쪽으로 당겨서
- 왼쪽의 식도를 노출 
- Recurrent laryngeal nerve > 신장 근처에서 좌우측으로 돌아서 후두/기관/식도로 다시 올라옴. 
...
>[!check] Key Points
>- 마추 전 반드시 위를 비울 것 : 위내 식이 ↑ 구토 ↑ & 역류성 식도염 → 위산으로 인해 식도내 산도가 높아짐 → 염증을 일으킴.
>- 초근 수술 이력이 중요: 협착은 손상을 받고 바로 일어나는 것이ㅣ 안라, healing 과정에서 일어남. 수술 받고 2-3주 뒤..
...
- Pulsion (압출성 게실) : 과도한 내강 내 압력, 식도 근육층을 통해 점막 탈출
- 견인성 (바깥에서 잡아당기는)
...
|          |                                     |
| -------- | ----------------------------------- |
| Pulsion  | 점막과 점막 사이를 근육이 비집고 나와 주머니처럼 튀어나온 것. |
| Traction | parabronchial 이 흔함                  |
