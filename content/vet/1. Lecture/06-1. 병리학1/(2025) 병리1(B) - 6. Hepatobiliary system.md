...
|          **Chronic hepatitis**           | 만성 염증 = **fibrosis** !!<br>- 육아종성 염증 (결절 형태) 많음<br>++Chronic suppurative++ (화농성이 만성으로 진행되면 abscess라고 한다)<br>- 육아종은 `대식세포와 림프구`를 결합조직이 둘러싸고 있다면,  농양은 `호중구와 괴사된 세포들`이 결합조직에 둘러싸여 있는 것 (퍼져나가지 못하도록)                                                                         |
...
![[Pasted image 20251216212914.png|350]]
