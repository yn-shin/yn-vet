...
| Proteinuria      |                                                                                                                                                |
|                  | - Pre-glomerular proteinuria<br>- Glomerular proteinuria<br>    : Protein-losing nephropathy (PLN)<br>- Post-glomerular proteinuria            |
...
| CBC              | - 비재생성 빈혈 (Nonregenerative anemia)<br>- 혈소판증가증 (Thrombocytosis)<br>- 고섬유소원혈증 (Hyperfibrinogenemia)                                             |

- [ ] **Proteinuria** : localization(유발된 곳), persistence(얼마나 지속), magnitude(심각한 정도)에 의해 판단
	- [ ] **Pre-glomerular proteinuria** : 순환하는 단백질 자체의 증가 (수혈, myeloma)
	- [ ] **Glomerular proteinuria** : 사구체에서 단백질이 빠져나가는 것 (선천적, 면역매개, 아밀로이드 축적 등)
		- Protein-losing nephropathy (PLN) : 사구체병증에 의해 단백질이 소실된 상태
	- [ ] **Post-glomerular proteinuria** : 하부 요로계의 염증, 종양
<br>
