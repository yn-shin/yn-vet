...
| ---------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------- |
| **GFR에 따른 BUN 수치**                                                                                                     |                                                   |
| - 신장이 심하게 손상되었을수록(GFR 수치가 낮을수록) BUN 수치 변화의 폭이 크다.<br>- GFR이 충분히 정상일 때는 BUN 수치 변화 폭이 작다.                                | ![[Pasted image 20240918010751.png\|300]]         |
| **Creatinine에 따른 GFR 수치**                                                                                              |                                                   |
| - GFP 수치가 낮을수록(신장 손상이 심할수록) creatinine의 농도 변화폭이 크다.                                                                    | ![[Pasted image 20240918010827.png\|300]]         |
| **BUN/SCr ratio**                                                                                                      | (pre-renal과 post-renal 감별 가능)                     |
| - 민감도를 높이기 위해 비율 단위를 이용할 수는 있으나,<br>- 식이나 근육량에 따라 각각의 값이 달라지므로 임상적 효용 가치는 떨어지는 편.<br>- Reference range : 개와 고양이에서 7-37 | ![[Pasted image 20240918011043.png\|300]]<br><br> |

>[!check] BUN과 SCr의 relationship
> **GFR에 따른 BUN 수치**
> 
